        ...
        <li className="p-6 shadow-xl rounded-xl ring-1 ring-black/5 shadow-black/10">
            ...
            <ul className="mt-6 space-y-1.5">
                <li className="flex items-center gap-1.5 font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-5 h-5 text-violet-600" fill="none"
            ...
            <a className="flex mt-3 justify-center bg-gray-100 rounded rounded-xl py-1"
